  ...
  static List<Property> sampleData = [
    Property(
      ...
      photoUrls: [
        ...
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcShLYI-xFEj8eMaGh7BII4BGCvvz8DHEZnKP6GHnZta&s'
      ],
    ),
    Property(
      id: const Uuid().v4(),
      ...
      photoUrls: [
        ...
        'https://source.unsplash.com/random/?bedroom'
        "https://prefabex.com/storage/media/_94Single%20Storey%20Modular%20Homes.jpeg"
        "https://i.pinimg.com/736x/9d/98/06/9d9806da020eaf14c2ba4783e69fb2d7.jpg"
      ],
    ),
  ];
}
